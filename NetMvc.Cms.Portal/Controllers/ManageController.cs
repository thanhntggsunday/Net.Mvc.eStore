...
namespace NetMvc.Cms.Portal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IOrderBusinessService orderBusinessService)
        {
...
#region Helpers
        ...
        public IOrderBusinessService OrderBusinessService
        {
            get
            {
                if (_orderBusinessService == null)
                {
                    _orderBusinessService = new OrderBusinessService();
                }

                return _orderBusinessService;
            }
            set { _orderBusinessService = value; }
        }
        ...
        public ActionResult GetAllOrder()
        {
            ...
            try
            {
                viewModel.Data = OrderBusinessService.GetAllOrdersByEmail(User.Identity.Name, out transactional);
        ...
        public ActionResult Details(long id)
        {
            ...
            try
            {
                viewModel.OrderItem = OrderBusinessService.GetOrder(id, out transactional, out orderDetails);
